...
class L1BSVariables(Enum):
    ...
    stack_mask_vector_l1bs_echo_sar_ku = 'stack_mask_vector_l1bs_echo_sar_ku'
    look_ang_l1bs_echo_sar_ku = 'look_ang_l1bs_echo_sar_ku'
    t0_surf_l1bs_echo_sar_ku = 't0_surf_l1bs_echo_sar_ku'
    stack_mask_l1bs_echo_sar_ku = 'stack_mask_l1bs_echo_sar_ku'
...
class L1BSWriter(NetCDFWriter):
    ...
    def __init__(self, chd: CharacterisationFile, cnf: ConfigurationFile, cst: ConstantsFile, filename: str):
        ...
        # stack mask vector
        self.define_variable(
            L1BSVariables.stack_mask_vector_l1bs_echo_sar_ku,
            np.int16,
            (L1BSDimensions.time_l1bs_echo_sar_ku,
             L1BSDimensions.max_multi_stack_ind),
            long_name="stack mask vector: l1bs_echo_sar_ku mode",
            units="count",
            fill_value=32767
        )
        self.define_variable(
            L1BSVariables.look_ang_l1bs_echo_sar_ku,
            np.int16,
            (L1BSDimensions.time_l1bs_echo_sar_ku,
             L1BSDimensions.max_multi_stack_ind),
            long_name="doppler look angles in stack: l1bs_echo_sar_ku mode",
        ...
        self.define_variable(
            L1BSVariables.t0_surf_l1bs_echo_sar_ku,
            np.float32,
            (L1BSDimensions.time_l1bs_echo_sar_ku,),
            long_name="t0 surface: l1bs_echo_sar_ku mode",
            units = "seconds",
            fill_value=32767
        )
        self.define_variable(
            L1BSVariables.stack_mask_l1bs_echo_sar_ku,
            np.int8,
            (L1BSDimensions.time_l1bs_echo_sar_ku,
             L1BSDimensions.max_multi_stack_ind,
             L1BSDimensions.echo_sample_ind),
            long_name="stack mask: l1bs_echo_sar_ku mode",
            units="count",
            fill_value=127
        )
    ...
    def write_record(self, surface_location_data: SurfaceData) -> None:
        ...
        super().write_record(
            ...
            stack_mask_vector_l1bs_echo_sar_ku = surface_location_data.stack_mask_vector,
            look_ang_l1bs_echo_sar_ku = surface_location_data.look_angles_surf,
            stack_mask_l1bs_echo_sar_ku = surface_location_data.stack_mask,
            t0_surf_l1bs_echo_sar_ku = surface_location_data.t0_surf[surface_location_data.closest_burst_index]
        )
